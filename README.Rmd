...
The `SparseVFC` package is an R implementation of the Sparse Vector Field Consensus (SparseVFC) algorithm <https://doi.org/10.1016/j.patcog.2013.05.017> for robust vector field learning. Largely translated from the Matlab functions in <https://github.com/jiayi-ma/VFC>.
